...
logic [1:0] pc_cd, m_cd2;
logic r_cd, dm_cd, m_cd1, d_cd1, d_cd2;
logic [2:0] e_cd;
logic [3:0] alu_cd;
...
prog_cnt pc_0(.clk(clk), .pc_cd(pc_cd), .e_rd(e_rd), .program_counter(program_counter));
